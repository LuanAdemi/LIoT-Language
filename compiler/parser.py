...
from ast import Number, Sum, Sub, Print, Sleep, String, Output, PinOn, PinOff,setVar,getVar,Letter, Empty
    ...
    def __init__(self):
        self.pg = ParserGenerator(
            ...
            ['NUMBER', 'PRINTTOLCD', 'OPEN_PAREN', 'CLOSE_PAREN',
             'SEMI_COLON', 'SUM', 'SUB', 'STRING', 'SLEEP', 'OUTPUT', 'PINON', 'PINOFF', 'EQUAL', 'VAR','VARNAME','GETVAR']
        )
